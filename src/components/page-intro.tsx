...
export function TypewriterHeading({ text }: { text: string }) {
  ...
  return (
    <span className="relative inline" aria-label={text}>
      ...
      <span
        className={`inline-block ml-1.5 w-[3px] sm:w-[4px] md:w-[5px] h-[0.82em] align-baseline bg-[rgb(128,0,0)] transition-opacity duration-200 ${
  ...
  return (
    <section className="technical-grid border-b border-border pt-28 sm:pt-32 lg:pt-36 bg-background">
      <div className="technical-container pb-8 sm:pb-10 lg:pb-12">
        <Reveal>
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[rgba(128,0,0,0.08)] text-[rgb(128,0,0)] border border-[rgba(128,0,0,0.25)] text-[11px] font-bold uppercase tracking-[0.18em] rounded-xs">
